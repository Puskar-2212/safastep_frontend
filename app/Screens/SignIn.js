...
const SignUp = () => {
  ...
  const handleEmailSignup = async () => {
    ...
    if (result.success) {
      ...
      try {
        ...
        if (
          !backendResponse.ok &&
          !backendResult.detail?.includes("already registered")
        ) {
  ...
  const renderYearItem = ({ item }) => (
    ...
    >
      <Text
        style={[styles.gridButtonText, year === item && styles.selectedText]}
      >
        {item}
      </Text>
    </Pressable>
    ...
    >
      <Text
        style={[
          ...
          month === index + 1 && styles.selectedText,
        ]}
      >
        {item}
      </Text>
  ...
  const renderDayItem = ({ item }) => (
    ...
    >
      <Text
        style={[styles.gridButtonText, day === item && styles.selectedText]}
      >
        {item}
      </Text>
    </Pressable>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.methodToggle}>
                <Pressable
                  style={[
                    styles.methodButton,
                    signupMethod === "mobile" && styles.methodButtonActive,
                  ]}
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      <View style={styles.pinContainer}>
                        ...
                        >
                          <MaterialIcons
                            name={
                              isPinVisible ? "visibility" : "visibility-off"
                            }
                            size={22}
                            color="#6B7280"
                          />
